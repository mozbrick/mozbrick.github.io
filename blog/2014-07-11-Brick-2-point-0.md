...
The reason Brick is different from a project such as Bootstrap is because of its use of the new Web Components browser APIs. Web Components lets web developers do new exciting things with HTML, CSS, and JavaScript:
...
Using after deciding to use the platform.js polyfills and remove x-tag, Brick is being built from the ground-up to be lighter, more modular, and easier to contribute to. It's a big undertaking, so we're moving from 1.0 to 2.0 to reflect the scale of the work. It's a more-or-less reboot of the entire project, and both I and the team are very excited about it. We haven't been vocal enough about updates, but I'm committing to posting here as well as on Twitter at [@mozbrick](https://twitter.com/mozbrick/). Stay tuned!
